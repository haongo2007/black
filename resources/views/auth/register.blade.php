@extends('layouts.admin.app', ['class' => 'register-page', 'page' => __('Register Page'), 'contentClass' => 'register-page'])
                ...
                <form class="form" method="post" action="{{ route('admin.register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" name="phone" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Phone') }}">
