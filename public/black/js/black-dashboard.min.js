...
var blackDashboard = {
    ...
    initMinimizeSidebar: function() {
        0 != $(".sidebar-mini").length && (sidebar_mini_active == true), $(".minimize-sidebar").click(function() {
            false == sidebar_mini_active ? ($body.addClass("sidebar-mini"), sidebar_mini_active = true, localStorage.setItem("sidebar_mini_active", true), blackDashboard.showSidebarMessage("Sidebar mini activated...")) : ($body.removeClass("sidebar-mini"), sidebar_mini_active = false, localStorage.setItem("sidebar_mini_active", false),blackDashboard.showSidebarMessage("Sidebar mini deactivated..."));
